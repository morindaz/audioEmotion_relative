...
def load_data():
    ...
    pkl_file_xtrain = open('Train_y.pkl', 'rb')
    pkl_file_ytrain = open('Train_x.pkl', 'rb')
    pkl_file_xtest = open('Test_y.pkl', 'rb')
    pkl_file_ytest = open('Test_x.pkl', 'rb')
