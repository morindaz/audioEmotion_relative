...
def load_data():
    ...
    pkl_file_xtrain = open('Train_x_Categories.pkl', 'rb')
    pkl_file_ytrain = open('Train_y_Categories.pkl', 'rb')
    pkl_file_xtest = open('Test_x_Categories.pkl', 'rb')
    pkl_file_ytest = open('Test_y_Categories.pkl', 'rb')
